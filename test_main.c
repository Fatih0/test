...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
extern counters_s counters_struct;
extern volatile uint8_t f10ms;
extern volatile uint8_t f1sn;
/* USER CODE END 0 */
...
int main(void)
{
  ...
  yellowled_off;
  states_init();
  counters_struct.counter_motor_30times = 30;//reset kısmında 30kez çalışmalı mı?
  /* USER CODE END 2 */
